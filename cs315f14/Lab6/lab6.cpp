...
//Class: CS 315
//Assignment : Lab06
//Description: This Optical recognition program scans a bmp Image, identifies the boundries of each character in the 
//Image, changes the color of the characters and bounds each character by a rectangle box around it. Program will ask
//the user if the user would want to input the values and color themselves or use the default ones.Program will also
//count the number of lines, letters, and words in the program. 
//*******************************************************************************************************************
#include <iostream>
#include <string>
#include "EasyBMP.cpp"
...
void label(BMP & image, int xlow, int xhigh, int ylow, int yhigh, color c1, color c2, color c3, color c4)
{
  ...
  //count number of lines, letters, and words
  ...
  for (int i = 0; i < letters.size(); i++){
	...
	for (int k = 0; k < line.size(); k++){
	  if ((line[k+1].left - line[k].right) > averageWidth/2){
	    wordCount++;
	  }// end if
	}// end for
	lines++;
    ...
    // for last  line
      ...
      orderLetter(line);
      for (int k = 0; k < line.size(); k++){
	if ((line[k+1].left - line[k].right) > averageWidth/1.5){
	  wordCount++;
	}// end for
      }// end for
    }// end else if
...
int main(int argc, char *argv[])
{
 ...
 retry: // for invalid inputs
  cout <<"Would you like to enter the region of the input image and colors?" <<endl;
  cout <<"Please type Y OR N: "<< endl;
  cout <<"Y to Input values, and No to accept defaults:" <<endl;
  cout <<endl;
  cout <<"*************************************************************************" <<endl;
  cout << "Defaults values are:" << endl;
  cout << "xlow = ylow = 0, " <<"xhigh = Width of Image, yhigh = Height of Image" << endl;
  cout << "Colors: C1 = white, c2 = black, c3 = green and c4 = red" <<endl;
  cout<<"**************************************************************************" << endl;
  getline(cin,choice);
