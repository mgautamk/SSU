...
;;;Instructor: Dr. Watts
;;;Date: Spring 2016
;;;Description: This program sorts numbers/Integers using two methods,
;;;1st method is quicksort (ascending order is Implemented) and 2nd
;;;methid is mergesort (descending order is Implemented). There are
;;;helper functions to help each functions.
;;;**********************************************************************
