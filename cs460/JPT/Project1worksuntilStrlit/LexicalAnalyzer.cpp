...
static int table [][28] = 
//	  a   _   0   .   ;   +   -   /   *   %   =   <   >   &   ^   |   !   ~   (   )   ;   ?   :   ,  "   \t  \n other    
       {{ 1,  1,  2,  3, 13,  5,  6, 13, 13, 13, 13,  7,  9, 11, 13, 12, 13, 23, 23, 23, 23, 23, 23, 23, 14, 15, 16, 32},  // 0 starting
	{ 1,  1,  1, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21},  // 1 alpha or _ (or  number)
	{22, 22,  2,  4, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22},  // 2 number
	{31, 31,  4, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31},  // 3 period
	{22, 22,  4, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29},  // 4 number for decimal all was 22 after 4
	{24, 24, 24, 24, 24, 23, 24, 24, 24, 24, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24},  // 5 plus
	{24, 24, 24, 24, 24, 24, 23, 24, 24, 24, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24},  // 6 minus
	{24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 23,  8, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24},  // 7 less than
	{24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24},  // 8 second less than
	{24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 23, 24, 10, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24},  // 9 greater than
	{24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24},  // 10 second greater than
	{24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 23, 24, 24, 23, 24, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24},  // 11 ampersand
	{24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 23, 24, 24, 24, 24, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24},  // 12 vertical bar
	{24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 25, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24},  // any other
	{24, 24, 24, 24, 24, 24, 24, 25, 24, 24, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 16, 25}}; // open quote
...
//        }
	...
	//	cout << "THIs is testing " << line << "Length of line " << line.length() << endl;
	//	string temps;
	//	cin >> temps;
	...
	while (state >= 0 && line != "\n")
	{
		...
		switch (state)
		{
			...
			return IDENT_T;
		      ...
		      if (lexeme == "//") {
			cout << "position is " << pos << line[pos] << endl;
			if(line[pos+3] == '=') {
			  pos++;
			  // lexeme+= line[pos+3];
			  lexeme = "//=";
